...
// Control Types - Exam Scoring (mới)
#define SUBMIT_EXAM_ANSWERS "SUBMIT_EXAM_ANSWERS"
#define GET_EXAM_RESULTS "GET_EXAM_RESULTS"
#define GET_EXAM_SCORES "GET_EXAM_SCORES"
